...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        mid = inorder.index(preorder[0]) # in inorder mid = root index of current tree, in preorder mid = last index of last node in left sub tree
...
# Complexity:
# T: O(N^2) In the worst case, the algorithm may visit each node in both the preorder and inorder traversal, 
