...
class CarFleet:
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        stack = []
        for pos, speed in sorted(posSpeedPair)[::-1]:
            # append the time for each pos, speed pair in stack
...
print("Total no. of car fleets arriving at target: ", target, " with starting positions of cars: ", position, 
      " and speed: ", speed, " are: ", instance.carFleet(target, position, speed))
